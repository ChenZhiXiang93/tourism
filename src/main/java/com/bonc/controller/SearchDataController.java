...
public class SearchDataController {
	...
	public Boolean valid(String viewSpotStr) {
		//获取当前登录用户的信息
	...
	public String getRealTimePeopleNum(@RequestParam(value = "viewSpotStr", required = false) String viewSpotStr,
		...
		String res = "";
		Boolean flag = valid(viewSpotStr);
		if (flag){
    ...
    public String getCountryOrigin(@RequestParam(value="viewSpotStr",required=false)String viewSpotStr) throws Exception {
    	String res ="";
		Boolean flag = valid(viewSpotStr);
		if (flag){
    ...
    public String getProvinceOrigin(@RequestParam(value="viewSpotStr",required=false)String viewSpotStr) throws Exception {
    	String res ="";
		Boolean flag = valid(viewSpotStr);
		if (flag){
			String param = "viewSpotStr=" + viewSpotStr;
    ...
    public String getSexDistribute(@RequestParam(value="viewSpotStr",required=false)String viewSpotStr) throws Exception {
    	String res ="";
		Boolean flag = valid(viewSpotStr);
		if (flag){
			String param = "viewSpotStr=" + viewSpotStr;
    ...
    public String getAgeDistribute(@RequestParam(value="viewSpotStr",required=false)String viewSpotStr) throws Exception {
    	String res ="";
		Boolean flag = valid(viewSpotStr);
		if (flag){
			String param = "viewSpotStr=" + viewSpotStr;
